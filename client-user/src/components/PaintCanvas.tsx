...
//   const colorPalette = [
//     "#FF6B35", // כתום - צבע ראשי
//     "#FF8C42", // כתום בהיר
//     "#E55100", // כתום כהה
//     "#1976D2", // כחול - צבע ראשי
//     "#1565C0", // כחול כהה
//     "#42A5F5", // כחול בהיר
//     "#333333", // שחור
//     "#666666", // שחור בהיר
...
//     // Draw all fill operations first (they should be under everything else)
//     fillOperations.forEach((fillOp) => {
...
//         ctx.lineWidth = 2
//         ctx.setLineDash([5, 5])
//         ctx.strokeRect(sticker.x - sticker.size / 2, sticker.y - sticker.height / 2, sticker.size, sticker.size)
//         ctx.setLineDash([])
//         drawResizeHandles(ctx, {
//           x: sticker.x,
//           y: sticker.y,
...
//                   "@keyframes glow": {
//                     "0%": {
//                       boxShadow: `0 0 5px ${alpha("#1976D2", 0.5)}, 0 0 10px ${alpha("#1976D2", 0.3)}`,
//                     },
//                     "50%": {
//                       boxShadow: `0 0 20px ${alpha("#1976D2", 0.8)}, 0 0 30px ${alpha("#1976D2", 0.5)}`,
//                     },
//                     "100%": {
//                       boxShadow: `0 0 5px ${alpha("#1976D2", 0.5)}, 0 0 10px ${alpha("#1976D2", 0.3)}`,
//                     },
...
//                           width: "200%",
//                           height: "200%",
//                           background: `radial-gradient(circle, ${alpha("#42A5F5", 0.8)} 0%, transparent 70%)`,
...
//                 },
//                 border:
//                   colorOption === color ? `3px solid #FF6B35` : colorOption === "#FFFFFF" ? "1px solid #ddd" : "none",
//                 boxShadow:
//                   colorOption === color
